    ...
    <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{asset('backend/images/person_2.jpg')}}');">
        <div class="container">
            ...
            <div class="col-md-12 col-lg-8 main-content">
              ...
              <div class="row mb-5 mt-5">
                <div class="col-md-12 mb-4">
                  <img src="{{asset('backend/images/person_1.jpg')}}" alt="Image placeholder" class="img-fluid rounded">
                </div>
                <div class="col-md-6 mb-4">
                  <img src="{{asset('backend/images/person_2.jpg')}}" alt="Image placeholder" class="img-fluid rounded">
                </div>
                <div class="col-md-6 mb-4">
              ...
              <div class="sidebar-box">
                ...
                <div class="post-entry-sidebar">
                  <ul>
                    <li>
                      <a href="">
                        <img src="{{asset('backend/images/person_1.jpg')}}" alt="Image placeholder" class="mr-4">
                        <div class="text">
                    ...
                    <li>
                      <a href="">
                        <img src="{{asset('backend/images/person_2.jpg')}}" alt="Image placeholder" class="mr-4">
                        <div class="text">
                          <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                          <div class="post-meta">
                            <span class="mr-2">March 15, 2018 </span>
          ...
          <div class="row align-items-stretch retro-layout">
            ...
            <div class="col-md-7">
              ...
              <div class="two-col d-block d-md-flex">
                <a href="single.html" class="hentry v-height img-2 gradient" style="background-image: url('{{asset('backend/images/person_2.jpg')}}');">
